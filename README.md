...
* [PostgreSQL](https://github.com/dhamaniasad/awesome-postgres) ⭐ 12,049 | 🐛 66 | 📅 2026-05-21 - There is alread a whole awesome list just for PostgreSQL.
* [MySQL](https://github.com/shlomi-noach/awesome-mysql) ⭐ 2,608 | 🐛 16 | 🌐 Python | 📅 2026-08-17 - There is already a whole awesome list just for MySQL.
...
* [PgCLI](https://github.com/dbcli/pgcli) ⭐ 13,354 | 🐛 39 | 🌐 Python | 📅 2026-08-18 - Postgres CLI with autocompletion and syntax highlighting
* [WhoDB](https://github.com/clidey/whodb) ⭐ 5,008 | 🐛 23 | 🌐 Go | 📅 2026-08-18 - SQL/NoSQL/Graph/Cache/Object data explorer with AI-powered chat + other useful features
...
* [SQLPage](https://github.com/lovasoa/SQLpage) ⭐ 2,542 | 🐛 141 | 🌐 Rust | 📅 2026-08-18 - Open-source SQL-only website builder
...
* [sqruff](https://github.com/quarylabs/sqruff) ⭐ 1,372 | 🐛 45 | 🌐 Rust | 📅 2026-08-18 - A SQL linter and formatter written in Rust that supports various SQL dialects and integrates with VSCode through a plugin.
...
* [SlowQL](https://github.com/makroumi/slowql) ⭐ 223 | 🐛 2 | 🌐 Rust | 📅 2026-06-30 - SQL static analyzer with extensive rules for security, performance, and quality. Zero dependencies, completely offline.
...
* [sqlaxe](https://github.com/djberube/sqlaxe) ⭐ 8 | 🐛 1 | 🌐 Python | 📅 2026-08-17 - CLI tool for searching, filtering, formatting, and splitting SQL files. Supports 40+ dialects of SQL.
...
* [SQL Syntax Cheat Sheet](https://github.com/mergisi/sql-syntax-cheat-sheet) ⭐ 53 | 🐛 0 | 📅 2026-03-09 - Comprehensive SQL reference including: DDL, DML, JOINs, window functions, CTEs, performance tips, and common mistakes.
