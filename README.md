...
* [PostgreSQL](https://github.com/dhamaniasad/awesome-postgres) ⭐ 12,087 | 🐛 70 | 📅 2026-08-31 - There is alread a whole awesome list just for PostgreSQL.
* [MySQL](https://github.com/shlomi-noach/awesome-mysql) ⭐ 2,613 | 🐛 18 | 🌐 Python | 📅 2026-09-14 - There is already a whole awesome list just for MySQL.
...
* [SchemaSpy](https://github.com/schemaspy/schemaspy) ⭐ 3,721 | 🐛 302 | 🌐 HTML | 📅 2026-03-05 - we will do the best to simplify documentation process of your database
* [SQLPage](https://github.com/lovasoa/SQLpage) ⭐ 2,561 | 🐛 131 | 🌐 Rust | 📅 2026-09-14 - Open-source SQL-only website builder
...
* [sqruff](https://github.com/quarylabs/sqruff) ⭐ 1,388 | 🐛 390 | 🌐 Rust | 📅 2026-09-14 - A SQL linter and formatter written in Rust that supports various SQL dialects and integrates with VSCode through a plugin.
