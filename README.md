...
* [PostgreSQL](https://github.com/dhamaniasad/awesome-postgres) ⭐ 12,103 | 🐛 75 | 📅 2026-08-31 - There is alread a whole awesome list just for PostgreSQL.
...
* [WhoDB](https://github.com/clidey/whodb) ⭐ 5,030 | 🐛 25 | 🌐 Go | 📅 2026-09-25 - SQL/NoSQL/Graph/Cache/Object data explorer with AI-powered chat + other useful features
* [SchemaSpy](https://github.com/schemaspy/schemaspy) ⭐ 3,729 | 🐛 303 | 🌐 HTML | 📅 2026-03-05 - we will do the best to simplify documentation process of your database
* [SQLPage](https://github.com/lovasoa/SQLpage) ⭐ 2,567 | 🐛 141 | 🌐 Rust | 📅 2026-09-25 - Open-source SQL-only website builder
...
* [sqruff](https://github.com/quarylabs/sqruff) ⭐ 1,397 | 🐛 305 | 🌐 Rust | 📅 2026-09-25 - A SQL linter and formatter written in Rust that supports various SQL dialects and integrates with VSCode through a plugin.
...
* [SQL tips and tricks](https://github.com/ben-nour/SQL-tips-and-tricks) ⭐ 2,308 | 🐛 2 | 🌐 SQL | 📅 2025-11-23 - SQL tips that cover everything from readability to common pitfalls.
