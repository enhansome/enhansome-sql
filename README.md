# awesome-sql with stars

List of tools and techniques for working with relational databases inspired by other awesome lists.

* [PostgreSQL](https://github.com/dhamaniasad/awesome-postgres) ⭐ 12,044 | 🐛 63 | 📅 2026-05-21 - There is alread a whole awesome list just for PostgreSQL.
* [MySQL](https://github.com/shlomi-noach/awesome-mysql) ⭐ 2,603 | 🐛 21 | 🌐 Python | 📅 2026-07-14 - There is already a whole awesome list just for MySQL.
...
* [Alexandria PL/SQL Utility Library](https://github.com/mortenbra/alexandria-plsql-utils) ⭐ 834 | 🐛 41 | 🌐 PLSQL | 📅 2023-03-10 - Collection of utility packages for PL/SQL
...
* [MSSqlCLI](https://github.com/dbcli/mssql-cli) ⭐ 1,412 | 🐛 162 | 🌐 Python | 📅 2024-02-26 - A command-line client for SQL Server with auto-completion and syntax highlighting

## <a name="formatter"></a>Formatters

* [SQL Format](http://www.dpriver.com/pp/sqlformat.htm) - Instant SQL Formatter
* [Poor SQL](http://poorsql.com/) - Instant Free and Open-Source T-SQL Formatting (look here for the plugins and whatnot: <https://github.com/TaoK/PoorMansTSqlFormatter> ⭐ 1,020 | 🐛 158 | 🌐 JavaScript | 📅 2023-07-14 )
...
* [WhoDB](https://github.com/clidey/whodb) ⭐ 5,007 | 🐛 19 | 🌐 Go | 📅 2026-08-13 - SQL/NoSQL/Graph/Cache/Object data explorer with AI-powered chat + other useful features
* [SchemaSpy](https://github.com/schemaspy/schemaspy) ⭐ 3,704 | 🐛 302 | 🌐 HTML | 📅 2026-03-05 - we will do the best to simplify documentation process of your database
* [SQLPage](https://github.com/lovasoa/SQLpage) ⭐ 2,538 | 🐛 135 | 🌐 Rust | 📅 2026-08-13 - Open-source SQL-only website builder
...
* [sqruff](https://github.com/quarylabs/sqruff) ⭐ 1,370 | 🐛 52 | 🌐 Rust | 📅 2026-08-13 - A SQL linter and formatter written in Rust that supports various SQL dialects and integrates with VSCode through a plugin.
...
* [ThalamusDB](https://github.com/itrummer/thalamusdb) ⭐ 118 | 🐛 0 | 🌐 Python | 📅 2025-08-27 - SQL with AI operators on text, images, and sound files.
...
* [sql-splitter](https://github.com/HelgeSverre/sql-splitter) ⭐ 13 | 🐛 0 | 🌐 Rust | 📅 2026-08-12 - CLI for splitting, merging, converting, and analyzing SQL dump files across MySQL, PostgreSQL, SQLite, and MSSQL.
* [sqlaxe](https://github.com/djberube/sqlaxe) ⭐ 8 | 🐛 1 | 🌐 Python | 📅 2025-02-21 - CLI tool for searching, filtering, formatting, and splitting SQL files. Supports 40+ dialects of SQL.
...
* [SQL tips and tricks](https://github.com/ben-nour/SQL-tips-and-tricks) ⭐ 2,302 | 🐛 2 | 🌐 SQL | 📅 2025-11-23 - SQL tips that cover everything from readability to common pitfalls.
* [SQL Syntax Cheat Sheet](https://github.com/mergisi/sql-syntax-cheat-sheet) ⭐ 52 | 🐛 0 | 📅 2026-03-09 - Comprehensive SQL reference including: DDL, DML, JOINs, window functions, CTEs, performance tips, and common mistakes.
