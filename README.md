...
* [PostgreSQL](https://github.com/dhamaniasad/awesome-postgres) ⭐ 12,050 | 🐛 66 | 📅 2026-05-21 - There is alread a whole awesome list just for PostgreSQL.
* [MySQL](https://github.com/shlomi-noach/awesome-mysql) ⭐ 2,607 | 🐛 16 | 🌐 Python | 📅 2026-08-17 - There is already a whole awesome list just for MySQL.
...
* [SQLPage](https://github.com/lovasoa/SQLpage) ⭐ 2,543 | 🐛 141 | 🌐 Rust | 📅 2026-08-18 - Open-source SQL-only website builder
...
* [sqruff](https://github.com/quarylabs/sqruff) ⭐ 1,373 | 🐛 45 | 🌐 Rust | 📅 2026-08-19 - A SQL linter and formatter written in Rust that supports various SQL dialects and integrates with VSCode through a plugin.
...
* [sql-splitter](https://github.com/HelgeSverre/sql-splitter) ⭐ 13 | 🐛 0 | 🌐 Rust | 📅 2026-08-19 - CLI for splitting, merging, converting, and analyzing SQL dump files across MySQL, PostgreSQL, SQLite, and MSSQL.
