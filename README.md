...
* [PostgreSQL](https://github.com/dhamaniasad/awesome-postgres) ⭐ 12,076 | 🐛 61 | 📅 2026-08-31 - There is alread a whole awesome list just for PostgreSQL.
* [MySQL](https://github.com/shlomi-noach/awesome-mysql) ⭐ 2,612 | 🐛 19 | 🌐 Python | 📅 2026-08-17 - There is already a whole awesome list just for MySQL.
...
* [MSSqlCLI](https://github.com/dbcli/mssql-cli) ⭐ 1,416 | 🐛 162 | 🌐 Python | 📅 2024-02-26 - A command-line client for SQL Server with auto-completion and syntax highlighting
...
* [PgCLI](https://github.com/dbcli/pgcli) ⭐ 13,376 | 🐛 40 | 🌐 Python | 📅 2026-09-09 - Postgres CLI with autocompletion and syntax highlighting
* [WhoDB](https://github.com/clidey/whodb) ⭐ 5,022 | 🐛 38 | 🌐 Go | 📅 2026-09-09 - SQL/NoSQL/Graph/Cache/Object data explorer with AI-powered chat + other useful features
* [SchemaSpy](https://github.com/schemaspy/schemaspy) ⭐ 3,717 | 🐛 302 | 🌐 HTML | 📅 2026-03-05 - we will do the best to simplify documentation process of your database
* [SQLPage](https://github.com/lovasoa/SQLpage) ⭐ 2,559 | 🐛 135 | 🌐 Rust | 📅 2026-09-09 - Open-source SQL-only website builder
...
* [sqruff](https://github.com/quarylabs/sqruff) ⭐ 1,383 | 🐛 170 | 🌐 Rust | 📅 2026-09-09 - A SQL linter and formatter written in Rust that supports various SQL dialects and integrates with VSCode through a plugin.
