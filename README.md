...
* [PostgreSQL](https://github.com/dhamaniasad/awesome-postgres) ⭐ 12,104 | 🐛 75 | 📅 2026-08-31 - There is alread a whole awesome list just for PostgreSQL.
* [MySQL](https://github.com/shlomi-noach/awesome-mysql) ⭐ 2,614 | 🐛 19 | 🌐 Python | 📅 2026-09-22 - There is already a whole awesome list just for MySQL.
...
* [Alexandria PL/SQL Utility Library](https://github.com/mortenbra/alexandria-plsql-utils) ⭐ 837 | 🐛 41 | 🌐 PLSQL | 📅 2023-03-10 - Collection of utility packages for PL/SQL
* [PLSQL-JSON](https://github.com/doberkofler/PLSQL-JSON) ⭐ 49 | 🐛 1 | 🌐 PLSQL | 📅 2020-03-11 - PL/SQL library to encode/decode JSON
...
* [PgCLI](https://github.com/dbcli/pgcli) ⭐ 13,400 | 🐛 49 | 🌐 Python | 📅 2026-09-20 - Postgres CLI with autocompletion and syntax highlighting
* [WhoDB](https://github.com/clidey/whodb) ⭐ 5,031 | 🐛 36 | 🌐 Go | 📅 2026-09-24 - SQL/NoSQL/Graph/Cache/Object data explorer with AI-powered chat + other useful features
* [SchemaSpy](https://github.com/schemaspy/schemaspy) ⭐ 3,728 | 🐛 303 | 🌐 HTML | 📅 2026-03-05 - we will do the best to simplify documentation process of your database
* [SQLPage](https://github.com/lovasoa/SQLpage) ⭐ 2,566 | 🐛 144 | 🌐 Rust | 📅 2026-09-24 - Open-source SQL-only website builder
...
* [sqruff](https://github.com/quarylabs/sqruff) ⭐ 1,392 | 🐛 248 | 🌐 Rust | 📅 2026-09-24 - A SQL linter and formatter written in Rust that supports various SQL dialects and integrates with VSCode through a plugin.
...
* [SQL tips and tricks](https://github.com/ben-nour/SQL-tips-and-tricks) ⭐ 2,306 | 🐛 2 | 🌐 SQL | 📅 2025-11-23 - SQL tips that cover everything from readability to common pitfalls.
